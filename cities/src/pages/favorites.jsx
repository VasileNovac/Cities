...
class MySearch extends React.Component {
      ...
      .then(data => 
        ...
        items: data.cities.map((x, index) => 
          <div key={x.idx} className="poza">
            ...
            <p>{x.nume}
            <span> - </span>
            <span><Link href={{pathname: '/cityPageF', query: {id: x.idx, name: x.nume, latitude: x.lat, longitude: x.long, xfoto: x.foto, fnota: x.nota, fcomm: x.comm} }}>Read more...</Link></span>
            </p>
          </div>
        )
        })
  ...
  render() {
    return (
      <div>
        <form onSubmit={this.handleFetch} name="xx">
          <input
            type="hidden"
            name="search"
